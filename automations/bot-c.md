...
If a box already has hitting or pitching from a PDF text extract, leave those lines for the director to approve. Read the file yourself only when the note says it has no text layer or no headers.
